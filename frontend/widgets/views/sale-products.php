                            ...
                            <div class="products">
                                ...
                                <div class="product">
                                    ...
                                    <a href="<?=\yii\helpers\Url::to(['/product/view' , 'slug' => $model->slug])?>" class="woocommerce-LoopProduct-link">
                                        <span class="onsale">
                                            <span class="woocommerce-Price-amount amount">
                                                <span class="woocommerce-Price-currencySymbol"></span><?=number_format($model->price - $model->discount , '0' , ' ' , ' ')?></span>
                                        </span>
                                    ...
                                    <div class="hover-area">
                                        <a class="button add_to_cart_button" href="cart.html" rel="nofollow">Savatga</a>
