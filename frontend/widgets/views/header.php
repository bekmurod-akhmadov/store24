                    ...
                    <ul id="menu-primary-menu" class="nav yamm">
                        <?php if(!empty($menus)): ?>
                            <?php foreach ($menus as $menu): ?>
                                <?php if ($menu->childCount == 0): ?>
                                    <li class="yamm-fw menu-item animate-dropdown">
                                        <a title="Super deals" href="<?=$menu->url?>"><?=$menu->name?></a>
                                    </li>
                                <?php else: ?>
                                    <li class="menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="<?=$menu->url?>"><?=$menu->name?> <span class="caret"></span></a>
                                        <ul role="menu" class=" dropdown-menu">
                                            <?php if (!empty($menu->childMenu)): ?>
                                                <?php foreach ($menu->childMenu as $item): ?>
                                                    <li class="menu-item animate-dropdown">
                                                        <a title="Wishlist" href="<?=$item->url?>"><?=$item->name?></a>
                                                    </li>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </ul>
...
<!--                        --><?php
//                            echo '<pre>';
//                            print_r($category->childCount);die;
//                            ?>
                        <?php if($category->childCount == 0): ?>
                                <li class="highlight menu-item animate-dropdown">
                                    <a  href="<?=\yii\helpers\Url::to(['/product/by-cat' , 'id' => $category->id])?>"><?=$category->name?></a>
                                </li>
                        <?php  else: ?>
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a  data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="<?=\yii\helpers\Url::to(['/product/by-cat' , 'id' => $category->id])?>"><?=$category->name?> <span class="caret"></span></a>
                                    <ul role="menu" class=" dropdown-menu">
            ...
            <ul id="site-header-cart" class="site-header-cart menu">
                <li class="animate-dropdown dropdown" id="animate-dropdown">
                    <a class="cart-contents" id="cart-contents" href="#" data-toggle="dropdown" title="View your shopping cart">
                        <i class="tm tm-shopping-bag"></i>
                        <span id="cart-count" data-quantity="<?=$session['cart.qty']?>" class="count">0</span>
                        <!--                        <span class="amount" style="font-size:13px;">-->
                        <!--                                <span class="price-label">Savatingiz</span>&#036;--><?//=!empty($session['cart.sum']) ? number_format($session['cart.sum'] , '0' , ' ' , ' ') : '0'?><!--</span>-->
                    </a>
                ...
                <div class="row">
                    ...
                    <div class="site-search">
                        <div class="widget woocommerce widget_product_search">
                            <form role="search" method="get" class="woocommerce-product-search" action="<?=\yii\helpers\Url::to(['/product/search'])?>">
                                <label class="screen-reader-text" for="woocommerce-product-search-field-0">Search for:</label>
                                <input type="text" id="woocommerce-product-search-field-0" class="search-field" placeholder="Search products&hellip;" name="search" />
